...
model.par =[0.000377125304442752*60, 0.00738924359598526*60, 1.53333782244337, 5.01927275636639,... 
    ...
    0.000377125304442752*60+1e-3, 0.00738924359598526*60+1e-3, 1.53333782244337+1e-3, 5.01927275636639+1e-3,... 
    0.00118831480244382*60+1e-3, 0.0461264539194078*60+1e-3, 0.000475563708997018*60+1e-3, 0.000301803966012407*60+1e-3, 68.8669567134881+1e-3]; % results of the fitting of the reduced model performed using CrossValidation equal on Stelling Data from processes (multiplication to 60 is to convert units from seconds to minutes)
