function [ res ] = M2SF_compute_steady_state_Analytical(theta, InitialStates_AU, initial_u)
% Computes the steady state of the MToggleSwitch model 2 for the given values of
...
L_RFP_AU= sc_molec_1*L_RFP; 
T_GFP_AU= sc_molec_2*T_GFP; 
