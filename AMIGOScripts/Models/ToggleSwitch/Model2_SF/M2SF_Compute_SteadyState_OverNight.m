function [InitialConditions]= M2SF_Compute_SteadyState_OverNight(inputs,params,InitialExpData,Initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.obs{1} = char('LacI_M2 = L_RFP_AU','TetR_M2 = T_GFP_AU');% Name of the observables 
newExps.exp_y0{1}=M2SF_compute_steady_state_Analytical(params,InitialExpData,Initial_u);     
