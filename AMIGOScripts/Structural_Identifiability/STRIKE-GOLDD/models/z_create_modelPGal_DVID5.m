...
% states
syms Cit_foldedP Cit_fluo

% unknown parameters
syms h1 Km1 alpha12GV d2 Kf         
...
% states variables:
x    = [Cit_foldedP;Cit_fluo];   

% parameters:
p    = [h1;Km1;alpha12GV;d2;Kf];

% dynamic equations:
f    = [alpha12GV*(IPTG^h1/(Km1^h1+IPTG^h1))-(d2+Kf)*Cit_foldedP;
        Kf*Cit_foldedP-d2*Cit_fluo];

% initial conditions: 
syms Cit_foldedP0 Cit_fluo0
ics = [Cit_foldedP0,Cit_fluo0];
% ics = [];
...
save('MIPr_model_DVID5','x','h','u','p','f','ics','known_ics');
