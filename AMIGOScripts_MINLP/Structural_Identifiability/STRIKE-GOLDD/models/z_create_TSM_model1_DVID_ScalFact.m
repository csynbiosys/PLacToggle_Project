...
% states
syms L_RFP_AU T_GFP_AU L_RFP T_GFP IPTGi aTci
...
% states variables:
x    = [L_RFP_AU;T_GFP_AU;L_RFP;T_GFP;IPTGi;aTci];   
...
% initial conditions: 
syms L_RFP0_AU T_GFP0_AU L_RFP0 T_GFP0 IPTGi0 aTci0
% ics = [L_RFP0,T_GFP0,IPTGi0,aTci0];
ics = [];

% which initial conditions are known:
% known_ics = [1 1 1 1 1 1]; 
known_ics = [0,0,0,0,1,1];

save('TSM_model1_SF_DVID','x','h','u','p','f','ics','known_ics');
