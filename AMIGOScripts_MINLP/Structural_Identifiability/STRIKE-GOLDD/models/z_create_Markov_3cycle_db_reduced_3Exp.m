% Markov model, cyclic, reduced, with u=constant and 2 experiments:
clear all;

% 2 -> 6 states
syms x1Exp1 x2Exp1 x1Exp2 x2Exp2 x1Exp3 x2Exp3
x = [x1Exp1 x2Exp1 x1Exp2 x2Exp2 x1Exp3 x2Exp3].';

% 1 -> 3 outputs
h = [x1Exp1 x1Exp2 x1Exp3].';

% 1 -> 3 inputs
syms u1Exp1 u1Exp2 u1Exp3
u = [u1Exp1 u1Exp2 u1Exp3].';
...
% initial conditions
ics  = []; 
known_ics = [1,0,1,0,1,0];

save('Markov_3cycle_db_reduced_3Exp','x','p','h','f','u','ics','known_ics');