function [InitialConditions]= M1vsM2SF_Compute_SteadyState_OverNight_ModelSelection(inputs,params,InitialExpData,Initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.obs{1} = char('LacI_M1 = L_RFP_AU','TetR_M1 = T_GFP_AU', 'LacI_M2 = L_RFP_AU2','TetR_M2 = T_GFP_AU2');% Name of the observables 
newExps.exp_y0{1}=M1vsM2SF_compute_steady_state_Analytical_ModelSelection(params,InitialExpData,Initial_u);     
