function [model] = ToggleSwitch_load_model_M1vsM2SF_ModelSelection()
...
model.n_par=34;                                                             % Number of model parameters 
...
model.st_names=char('IPTGi', 'aTci', 'L_RFP', 'T_GFP', 'L_RFP_AU', 'T_GFP_AU',...
                    'IPTGi2','aTci2','L_RFP2','T_GFP2','L_RFP_AU2','T_GFP_AU2');      % Names of the states    
...
model.eqns=...                                                              % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('dIPTGi = (k_in_IPTG*(u_IPTG-IPTGi)+((k_in_IPTG*(u_IPTG-IPTGi))^2)^0.5)/2-(k_out_IPTG*(IPTGi-u_IPTG)+((k_out_IPTG*(IPTGi-u_IPTG))^2)^0.5)/2',...
                    ...
                    'dL_RFP_AU = sc_molec_1a*dL_RFP',...
                    'dT_GFP_AU = sc_molec_2a*dT_GFP',...
                    ...
                    ...
                    'dL_RFP_AU2 = sc_molec_1b*dL_RFP2',...
                    'dT_GFP_AU2 = sc_molec_2b*dT_GFP2');
